...
type RegisterServerRequest struct {
	TopologyStreamUri    string   `protobuf:"bytes,1,opt,name=topology_stream_uri,json=topologyStreamUri,proto3" json:"topology_stream_uri,omitempty"`
...
func (*RegisterServerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_827f2b64ddfdb030, []int{9}
}
...
func (m *RegisterServerRequest) GetTopologyStreamUri() string {
	if m != nil {
		return m.TopologyStreamUri
	}
	return ""
}
...
func (m *RegisterServerRequest) GetServerAddr() string {
	if m != nil {
		return m.ServerAddr
	}
	return ""
...
func (*RegisterServerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_827f2b64ddfdb030, []int{10}
}
...
func (m *RegisterServerResponse) GetTopologyStreamUri() string {
	if m != nil {
		return m.TopologyStreamUri
	}
	return ""
...
func (m *RegisterServerResponse) GetServerId() string {
	if m != nil {
		return m.ServerId
	}
	return ""
...
func (m *RegisterServerResponse) GetServerAddr() string {
	if m != nil {
		return m.ServerAddr
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*RegisterServerResponse)(nil), "RegisterServerResponse")
}
...
var fileDescriptor_827f2b64ddfdb030 = []byte{
	...
	,
}
...
func (m *RegisterServerRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.TopologyStreamUri) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintWalle(dAtA, i, uint64(len(m.TopologyStreamUri)))
		i += copy(dAtA[i:], m.TopologyStreamUri)
	}
	if len(m.ServerId) > 0 {
		dAtA[i] = 0x12
		i++
	...
	if len(m.ServerAddr) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintWalle(dAtA, i, uint64(len(m.ServerAddr)))
...
func (m *RegisterServerResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *RegisterServerResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *RegisterServerResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RegisterServerRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TopologyStreamUri", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.TopologyStreamUri = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ServerId", wireType)
...
func (m *RegisterServerResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RegisterServerResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RegisterServerResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
