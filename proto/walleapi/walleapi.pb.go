...
type ClaimWriterResponse struct {
	...
	LastEntry            *Entry   `protobuf:"bytes,2,opt,name=last_entry,json=lastEntry,proto3" json:"last_entry,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type Topology struct {
	...
	Servers              map[string]*ServerInfo `protobuf:"bytes,3,rep,name=servers,proto3" json:"servers,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}               `json:"-"`
	XXX_unrecognized     []byte                 `json:"-"`
	XXX_sizecache        int32                  `json:"-"`
}
...
type StreamTopology struct {
	...
	PrevServerIds        []string `protobuf:"bytes,3,rep,name=prev_server_ids,json=prevServerIds,proto3" json:"prev_server_ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *StreamTopology) GetPrevServerIds() []string {
	if m != nil {
		return m.PrevServerIds
	}
	return nil
}
...
var fileDescriptor_3b522378fad0fbf4 = []byte{
	...
	,
}
...
func (m *StreamTopology) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PrevServerIds) > 0 {
		for _, s := range m.PrevServerIds {
			dAtA[i] = 0x1a
			i++
			l = len(s)
			for l >= 1<<7 {
...
func (m *StreamTopology) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrevServerIds", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.PrevServerIds = append(m.PrevServerIds, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipWalleapi(dAtA[iNdEx:])
